...
export default function VerificationPage() {
  const [scanResult, setScanResult] = useState<BackendScanResponse | null>(null);
            ...
            {!scanResult ? (
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="font-mono text-xs">scan-{scanResult?.id}</CardDescription>
                </CardHeader>
                <CardContent className="space-y-5">
                  ...
                  {done && (
                    <Link to="/reports/$reportId" params={{ reportId: String(scanResult?.id ?? "") }}>
